        ...
        <ol>
          <li>
            ...
            <Typography variant="body2" color="textSecondary" component="p">
              ...
              Policy. You acknowledge that you have read and understood
          ...
          <li>
            ...
            <Typography variant="body2" color="textSecondary" component="p">
              Any contests, sweepstakes or other promotions made available
          ...
          <li>
            ...
            <Typography variant="body2" color="textSecondary" component="p">
              ...
              <ul>
                <li>
                  Content is yours and/or you have the right to use it and the
                  right to grant us the rights and license as provided in these
                  Terms.
                </li>
                <li>
                  and that the posting of your Content on or through Service
          ...
          <li>
            ...
            <Typography variant="body2" color="textSecondary" component="p">
              ...
              laws of Vietnam, which governing law applies to agreement without
