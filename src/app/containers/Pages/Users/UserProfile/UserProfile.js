        ...
        <div className="content container-fluid">
          ...
          <div className="container-fluid">
            ...
            <div className="row">
              <div className="col-12 col-sm-3">
                <Link
                  to={`/User/Profile/Detail/imageArtist/${props.userId}/null`}
                >
                  <div className="card">
                    <CardActionArea>
                      <div className="card-body">
              ...
              <div className="col-12 col-sm-3">
                <Link
                  to={`/User/Profile/Detail/musicArtist/${props.userId}/null`}
                >
                  <div className="card">
                    <CardActionArea>
                      <div className="card-body">
              ...
              <div className="col-12 col-sm-3">
                <Link
                  to={`/User/Profile/Detail/executiveProducer/${props.userId}/null`}
                >
                  <div className="card">
                    <CardActionArea>
                      <div className="card-body">
