...
function Drops() {
    ...
    let getMyDrops = (start, end) => {
        setOpen(true)
        axios.get(`/drop/saleType/auction/${start}/${end}`).then(
            (response) => {
        ...
        <div className="container-fluid">
            ...
            <div className="page-header">
                ...
                <div className="card-body">
                     ...
                     <h3><pre>Auction Drops<Link to="/dashboard/marketPlace" style={{ float: 'right', color: "#ff0000" }}>View All </Link></pre></h3>
                    ): (
                    
                        <h3><pre>Auction Drops
